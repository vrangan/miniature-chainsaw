...
public class ReplicationStatus {
    ...
    public ReplicationStatus(String sourceUri, String targetUri, String jobName,
                             ...
                             ReplicationStatus.Status status, long eventId) throws DRException {
    ...
    private void init(String source, String target, String job,
                      ...
                      long eventNum, String logStr) throws DRException {
        setSourceUri(source);
        setTargetUri(target);
        setJobName(job);
        setDatabase(dbName);
    ...
    public ReplicationStatus(String jsonString) throws DRException {
        try {
            ...
            try {
                ...
                throw new DRException("Unable to deserialize jsonString to ReplicationStatus."
            ...
            throw new DRException("Unable to deserialize jsonString to ReplicationStatus ", e);
        }
    ...
    public String toJsonString() throws DRException {
        try {
            ...
            throw new DRException("Unable to serialize ReplicationStatus ", e);
        }
    }

    public JSONObject toJsonObject() throws DRException {
    ...
    public void setSourceUri(String source) throws DRException {
    ...
    public void setTargetUri(String target) throws DRException {
    ...
    public void setJobName(String jobName) throws DRException {
    ...
    public void setDatabase(String database) throws DRException {
    ...
    public void setStatus(Status status) throws DRException {
        if (status != null) {
            this.status = status;
        } else {
            throw new DRException("Failed to set ReplicationStatus. Input \""
    ...
    public void setEventId(long eventId) throws DRException {
        if (eventId > -1) {
    ...
    private void validateString(String inputName, String input) throws DRException {
