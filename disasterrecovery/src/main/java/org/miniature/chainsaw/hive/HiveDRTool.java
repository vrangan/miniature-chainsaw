...
import org.miniature.chainsaw.hive.mapreduce.CopyMapper;
import org.miniature.chainsaw.hive.mapreduce.CopyReducer;
...
import org.miniature.chainsaw.hive.util.HiveDRStatusStore;
...
//            }
    ...
    public Job execute() throws Exception {
        ...
        if (executionStage.equalsIgnoreCase(HiveDRUtils.ExecutionStage.LASTEVENTS.name())) {
            ...
            throw new DRException("Invalid Execution stage : " + inputOptions.getExecutionStage());
        }
    ...
    private void createStagingDirectory() throws IOException, DRException {
    ...
    private void cleanStagingDirectory() throws DRException {
    ...
    private synchronized void cleanup() throws DRException {
