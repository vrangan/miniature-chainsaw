...
import org.miniature.chainsaw.snapshot.util.MiniHdfsClusterUtil;
 ...
 */
public class HdfsSnapshotEvictorTest {
    ...
    public void evictionTest() throws Exception {
        ...
        HdfsSnapshotEvictor.evictSnapshots(miniDfs, evictionDir.toString(), "minutes(1)", NUM_FILES + 1);
        ...
        HdfsSnapshotEvictor.evictSnapshots(miniDfs, evictionDir.toString(), "minutes(1)", 2);
        fileStatuses = miniDfs.listStatus(snapshotDir);
        Assert.assertTrue(fileStatuses.length >= 5);
    }

    @Test(expectedExceptions = DRException.class,
    ...
    public void evictionTestCannotSnapshot() throws Exception {
        ...
        HdfsSnapshotEvictor.evictSnapshots(miniDfs, nonSnapshotDir.toString(), "minutes(1)", NUM_FILES);
    }
