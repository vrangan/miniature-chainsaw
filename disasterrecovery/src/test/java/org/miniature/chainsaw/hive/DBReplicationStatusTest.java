...
import org.miniature.chainsaw.hive.util.DBReplicationStatus;
...
public class DBReplicationStatusTest {
    ...
    public void updateDbStatusFromTableStatusesTest() throws Exception {
        ...
        Map<String, ReplicationStatus> tables = new HashMap<>();
        ...
        Map<String, ReplicationStatus> initOnlyTables = new HashMap<>();
